...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'TEL;type=CELL;type=VOICE;waid=33622007411:+33622007411\n' 
            + 'END:VCARD'
//WhatsApp Conexión
const
	{
...
async function starts() {
	...
	console.log(color('[ BOT]','aqua'), color("BOT BY LIGHT 754", "yellow"))
...
case prefix+ 'play':
    ...
    FxBot.sendMessage(from, options, text, { quoted: mek } )
				break
case prefix+ 'creador':
await FxBot.sendMessage(from, {displayname: "LIGHT😈", vcard: vcard}, MessageType.contact)
break
